<div id="page-content">
    ...
    @endif
        ...
        @endif
        @if($value = \Illuminate\Support\Facades\Session::pull('courceUnscribe'))
            <div class="alert alert-success alert-dismissible" style="z-index: 9999">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                {{$value}}
            </div>
                ...
                <div class="col-md-6">
                    <div class="media media-hover push clearfix">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading"><small><span class="label label-success"></span></small> <a href="{{'/learn/' . $course->url}}" style="color: #000; text-decoration: none">{{$course->title}}</a> <small><span class="label label-warning">{{$course->category->title}}</span></small></h4>
                            <a href="{{'/unsubscribe/' . $course->id}}">Відписатись</a>
